...
import { ExtendedModelInstance, ModelInstance } from '../../objects/instance';
...
export class ModelInstanceResourceComponent implements OnInit {
  @Input() instance: ExtendedModelInstance | undefined;
  ...
  private applyInstance(instance: ExtendedModelInstance, resourceProfileId: ResourceProfileId | string) {
