...
export LOG_LEVEL_ScalingManager="INFO"
export LOG_LEVEL_ScalingWorker="INFO"
export LOG_LEVEL_WorkRequestController="INFO"
export LOG_LEVEL_WorkRequestWorker="INFO"
export LOG_LEVEL_JobSubmissionTask="INFO"
export LOG_LEVEL_S3IntegrationController="INFO"
export LOG_LEVEL_AuthController="INFO"
export LOG_LEVEL_InstanceMetricsController="TRACE"
