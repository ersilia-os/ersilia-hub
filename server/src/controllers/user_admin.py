...
class UserAdminController:
    ...
    def clear_user_contributions(self, user_id: str):
        pass

    def delete_user(self, user_id: str):
        # clear_user_data -> clear_contribs -> clear WR -> delete permissions -> delete user
        pass
        ...
        try:
            results: list[UserAuthRecord] = UserAuthDAO.execute_insert(
                ...
                **UserAuthRecord.init(
                    ...
                    passwordhash=AuthUtils.generate_password_hash(
